...
(function () {
  ...
  function runExpansionCommand(state, command, arg, arg2, options = {}) {
    const table = {
      ...
      scout: () => scoutWithCompanion(state), fate_trial: () => startFateEvolutionTrial(state, arg), fate_evolve: () => evolveFate(state, arg, arg2, options), fate_transform: () => E.transformFate(state, arg, arg2, options), technique_evolve: () => chooseTechniqueEvolution(state, arg, arg2),
