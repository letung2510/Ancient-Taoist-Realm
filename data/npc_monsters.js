(function () {
  ...
  const entities = {
    disi_ruou_tien_nhan: base({ name: "Túy Tiên Nhân", interaction_type: "drink_challenge", appearance_weight: 0.05, disappear_after_interaction: true }),
    ...
    nghich_thuong_nhan: base({ name: "Nghịch Thương Nhân", race: "Vô Danh", black_market: true, trade_currency: "lifespan", shop_tier: [6, 8] }),
    luan_hoi_su_gia: base({ name: "Luân Hồi Sứ Giả", race: "U Minh", reincarnation_envoy: true, requires_lifespan_zero: true })
  };
  const lootTables = {
