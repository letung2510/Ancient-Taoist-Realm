...
- UI giữ cấu trúc hai cột nguyên bản: Sidebar trái chứa Nhân Vật/TabGroupNav/TabContent rồi Character Summary; Story Panel và Action Bar nằm bên phải. Character Summary chỉ ghim trong Sidebar, không đưa lên đầu toàn trang; Sidebar dùng chiều rộng tối thiểu cố định để tránh wrap, không ép tỷ lệ phần trăm.
